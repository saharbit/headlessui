...
import { Listbox } from '../../src/components/listbox/listbox' // TODO: Use `@headlessui/react`
...
export default function Home() {
  return (
    <>
      <Head>
        <title>Listbox with pure Tailwind- Playground</title>
      </Head>
...
function ListboxImplementation() {
