...
describe('Keyboard interactions', () => {
  describe('`Enter` key', () => {
    ...
    it(
      'should be possible to close the listbox with Enter and invoke the active listbox item',
      suppressConsoleLogs(async () => {
        ...
        // Close listbox, and invoke the item
        await press(Keys.Enter)
  ...
  describe('`Space` key', () => {
    ...
    it(
      'should be possible to close the listbox with Space and invoke the active listbox item',
      suppressConsoleLogs(async () => {
        const handleChange = jest.fn()
        render(
          <Listbox value={undefined} onChange={handleChange}>
